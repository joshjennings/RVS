 ...
 */
public class Intercooler extends Vessel {
	...
	public Intercooler(String model) {
		super(model);
		this.orientation = Orient.VERTICAL; //vertical required
	}
	...
	public String formattedDescription() {
		...
		return orientation + "Intercooler";
	}
